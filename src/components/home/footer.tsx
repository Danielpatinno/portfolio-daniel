  ...
  return (
    <footer className="border-t flex flex-col items-center justify-center h-20 border-primary">
      ...
      <div className="flex justify-center gap-4">
        <a 
          href="https://github.com/Danielpatinno"><FaGithubSquare size={30}/>
        </a>

        <a 
          href="https://www.linkedin.com/in/daniel-patino-9a1341249/"><FaLinkedin size={30}/>
        </a>

        <FaWhatsappSquare onClick={() => handleSendMessageWhatsapp()} size={30}/>
