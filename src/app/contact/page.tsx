    ...
    <main >
      <section className="flex flex-col lg:min-h-screen lg:flex-row container items-center justify-center mb-2 lg:justify-between">
        <div className="flex flex-col gap-4 lg:mb-8">
          ...
          <p className="mb-2 lg:text-xl">Por favor, complete o formulário e ficarei feliz em entrar em contato com você.</p>

          <div className="flex flex-col gap-6 mx-4 mb-10 lg:text-xl">
            <p 
              className="flex items-center gap-2"
            >
              <MdEmail size={20}/>Neniade777@gmail.com
            </p>

            <p 
              className="flex items-center gap-2"
            >
              <FaPhoneAlt size={20} />(44) 99845-1188
            </p>

            <p 
              className="flex items-center gap-2"
            >
              <FaLocationDot size={20} />Maringá-PR
            </p>
          </div>
